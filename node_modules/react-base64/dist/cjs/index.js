...
const Base64 = (props) => {
    switch (props.mode) {
        case "encode":
            return React.createElement("p", null, utf8_to_b64$1(props.data));
        case "decode":
            return React.createElement("p", null, b64_to_utf8$1(props.data));
    }
};
...
const Base64Raw = (props) => {
    switch (props.mode) {
        case "encode":
            return React.createElement(React.Fragment, null, utf8_to_b64(props.data));
        case "decode":
            return React.createElement(React.Fragment, null, b64_to_utf8(props.data));
    }
};

exports.Base64 = Base64;
exports.Base64Raw = Base64Raw;
